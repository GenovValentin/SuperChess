...
#region  Initialization
    ...
    private void HandleMouseButtonUp(Vector2Int hitPosition)
    {
        if (selectedPiece != null)
        {
            ...
            if (hitPosition == CloneChessPiece(selectedPiece))
            {
                selectedPiece
            ...
            {
                selectedPiece
                    .SetPosition(GetTileCenter(CloneChessPiece(selectedPiece).x,
                    CloneChessPiece(selectedPiece).y));
                currentlyDragging = null;
                lastSelectedState = false;
                lastSelectedPiece = null;
                selectedPiece = null;
        ...
        // Additional code for handling other mouse up events if needed
    }
    ...
    private void HandleMouseButtonDown(Vector2Int hitPosition)
    {
        ...
        // If the same piece was clicked again, toggle its selection state
        ...
        {
            // A new piece was clicked, deselect the previous one

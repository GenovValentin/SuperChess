...
public class VolumeControl : MonoBehaviour
{
    ...
    {
        maxVolumeImage = Resources.Load<Image>("Volume_Icons/Volume_Max");
        midVolumeImage = Resources.Load<Image>("Volume_Icons/Volume_Mid");
        minVolumeImage = Resources.Load<Image>("Volume_Icons/Volume_Min");
        mutedVolumeImage = Resources.Load<Image>("Volume_Icons/Volume_Muted");
    }
}

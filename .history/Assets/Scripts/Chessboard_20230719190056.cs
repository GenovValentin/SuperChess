...
#region  Initialization
    ...
    private void SetPromotionPiecesImagesPaths()
    {
        whiteQueenImage =
            Resources
                .Load
                <Texture
                >("/home/valio/GitProjects/SuperChess/Assets/Prefabs/Pieces/Queen.png");
        blackQueenImage =
            Resources
                .Load
                <Texture
                >("/home/valio/GitProjects/SuperChess/Assets/Prefabs/Pieces/Queen_B.png");
        whiteRookImage =
            Resources
                .Load
                <Texture
                >("/home/valio/GitProjects/SuperChess/Assets/Prefabs/Pieces/Rook.png");
        blackRookImage =
            Resources
                .Load
                <Texture
                >("/home/valio/GitProjects/SuperChess/Assets/Prefabs/Pieces/Rook_B.png");
        whiteBishopImage =
            Resources
                .Load
                <Texture
                >("/home/valio/GitProjects/SuperChess/Assets/Prefabs/Pieces/Bishop.png");
        blackBishopImage =
            Resources
                .Load
                <Texture
                >("/home/valio/GitProjects/SuperChess/Assets/Prefabs/Pieces/Bishop_B.png");
        whiteKnightImage =
            Resources
                .Load
                <Texture
                >("/home/valio/GitProjects/SuperChess/Assets/Prefabs/Pieces/Knight.png");
        blackKnightImage =
            Resources
                .Load
                <Texture
                >("/home/valio/GitProjects/SuperChess/Assets/Prefabs/Pieces/Knight_B.png");
    }
    ...
    private void SetPromotionPiecesObjects()
    {
        ...
        promotionQueenImage = promotionQueen.GetChild(0).gameObject;

        promotionRook =
            promotionPieces.transform.GetChild(0).GetChild(1).gameObject;
        promotionRookImage = promotionRook.GetChild(0).gameObject;

        promotionBishop =
            promotionPieces.transform.GetChild(0).GetChild(2).gameObject;
        promotionBishopImage = promotionBishop.GetChild(0).gameObject;

        promotionKnight =
            promotionPieces.transform.GetChild(0).GetChild(3).gameObject;
        promotionKnightImage = promotionKnight.GetChild(0).gameObject;
    }
    ...
    private void SetPromotionPiecesImage(Team team)
    {
        ...
        promotionQueenImage.GetComponent<Image>() as RawImage = currentQueenImage;
        promotionRookImage.GetComponent<Image>() as RawImage = currentRookImage;
        promotionBishopImage.GetComponent<Image>() as RawImage = currentBishopImage;
        promotionKnightImage.GetComponent<Image>() as RawImage = currentKnightImage;
    }
    ...
    )
    {
        ...
        if (promotionPiece != ChessPieceType.None)
        {
            ...
            Debug.Log("Promoted " + move.promotionPieceType);
        }
    ...
    {
        Debug.Log("PromotePawn" + team + targetPiece.team);
        if (
        ...
        Debug.Log("Position" + lastPiece.transform.position);
    ...
    )
    {
        ...
        // ToDo Promotion after Button pressed
        if (currentlyDragging)
        {
            currentlyDragging = null;
        }

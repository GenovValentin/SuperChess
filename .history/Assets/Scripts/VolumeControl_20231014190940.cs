...
public class VolumeControl : MonoBehaviour
{
    ...
    private int GetVolumeIconState()
    {
        ...
        if (volumeIcon.GetComponent<Image>().sprite == minVolumeImage) return 1;
        if (volumeIcon.GetComponent<Image>().sprite == midVolumeImage) return 2;
        if (volumeIcon.GetComponent<Image>().sprite == maxVolumeImage) return 3;

...
#region  Initialization
    ...
    private ChessPieceType promotedPiece;
    ...
    private void ProcessPromotion()
    {
        ...
        PromotePawn(Team.White, targetPiece, lastMove);
        PromotePawn(Team.Black, targetPiece, lastMove);
    }
    ...
    private ChessPieceType OnQueenButton()
    {
        return promotedPiece = ChessPieceType.Queen;
    }

private ChessPieceType OnRookButton()
    {
        return promotedPiece = ChessPieceType.Rook;
    }

    private ChessPieceType OnBishopButton()
    {
        return promotedPiece = ChessPieceType.Bishop;
    }

    private ChessPieceType OnKnightButton()
    {
        return promotedPiece = ChessPieceType.Knight;
    }
    ...
    )
    {
        ...
        ChessPiece newQueen = SpawnSinglePiece(promotedPiece, team);

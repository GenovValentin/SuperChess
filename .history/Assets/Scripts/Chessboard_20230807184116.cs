...
#region  Initialization
    ...
    private void HandleMouseButtonUp(Vector2Int hitPosition)
    {
        ...
        {
            Vector2Int selectedPieceVector2Int = CloneChessPiece(selectedPiece);
            if (ContainsValidMove(ref selectedPieceAvailableMoves, hitPosition))
            {
                MoveTo(selectedPieceVector2Int.CurrentPosition.x,
                selectedPieceVector2Int.CurrentPosition.y,
                hitPosition.x,
                hitPosition.y);
                SendMoveToServer(selectedPieceVector2Int.CurrentPosition,
                hitPosition);
            }

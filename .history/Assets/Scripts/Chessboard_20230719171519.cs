...
#region  Initialization
    ...
    {
        ColorUtility.TryParseHtmlString("#E9E3D3", out whiteColor);
    ...
    private void SetPromotionPiecesColor(Team team)
    {
        ...
        promotionQueen.GetComponent<Button>().highlightedColor =
            currentHighlightedColor;
        promotionQueen.GetComponent<Button>().pressedColor =
            currentPressedColor;

        promotionRook.GetComponent<Image>().color = currentColor;
        promotionRook.GetComponent<Button>().highlightedColor =
            currentHighlightedColor;
        promotionRook.GetComponent<Button>().pressedColor = currentPressedColor;

        promotionBishop.GetComponent<Image>().color = currentColor;
        promotionBishop.GetComponent<Button>().highlightedColor =
            currentHighlightedColor;
        promotionBishop.GetComponent<Button>().pressedColor =
            currentPressedColor;

        promotionKnight.GetComponent<Image>().color = currentColor;
        promotionKnight.GetComponent<Button>().highlightedColor =
            currentHighlightedColor;
        promotionKnight.GetComponent<Button>().pressedColor =
            currentPressedColor;
    }

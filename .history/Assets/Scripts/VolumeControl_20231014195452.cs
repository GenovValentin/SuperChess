...
public class VolumeControl : MonoBehaviour
{
    ...
    private void SavePrefs(float volume)
    {
        ...
        // PlayerPrefs.SetInt("VolumeIconState", GetVolumeIconState());
    }
    ...
    private void LoadPrefs()
    {
        ...
        SetVolumeIconImage(audioSlider.value);
    }
    ...
    // private void SetVolumeIconState()
    // {
    // }

    // private int GetVolumeIconState()
    // {
    //     if (volumeIconImage == mutedVolumeImage)
    //     {
    //         return 0;
    //     }
    //     else if (volumeIconImage == minVolumeImage)
    //     {
    //         return 1;
    //     }
    //     else if (volumeIconImage == midVolumeImage)
    //     {
    //         return 2;
    //     }
    //     else if (volumeIconImage == maxVolumeImage)
    //     {
    //         return 3;
    //     }
    // }

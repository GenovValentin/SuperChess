...
#region  Initialization
    ...
    )
    {
        ...
        move.promotionPieceType = GetSocketChessPieceType(promotedPiece);
    ...
    private int GetSocketChessPieceType(ChessPieceType promotedPiece)
    {
        ...
        {
            case GetChessPieceType.Queen:
                return 1;
            case GetChessPieceType.Rook:
                return 2;
            case GetChessPieceType.Bishop:
                return 3;
            case GetChessPieceType.Knight:
                return 4;
        }
    }
    ...
    )
    {
        ...
        ChessPiece newPiece = SpawnSinglePiece(promotedPiece, team);
...
#region
    ...
    private void OnMakeMoveClient(NetMessage msg)
    {
        ...
        if (mm.teamId != (int) currentTeam)
        {
            ...
            if (specialMove = SpecialMove.Promotion)
            {
                mm = GetChessPieceType(mm.promotionPieceType);
            }
            MoveTo(mm.originalX,
            mm.originalY,
            mm.destinationX,

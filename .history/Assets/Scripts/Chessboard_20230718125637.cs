...
#region  Initialization
    ...
    private void OnQueenButton()
    {
        promotedPiece = ChessPieceType.Queen;
    }

    private void OnRookButton()
    {
        promotedPiece = ChessPieceType.Rook;
    }

    private void OnBishopButton()
    {
        promotedPiece = ChessPieceType.Bishop;
    }

    private void OnKnightButton()
    {
        promotedPiece = ChessPieceType.Knight;
    }

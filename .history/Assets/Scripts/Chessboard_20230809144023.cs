...
#region  Initialization
    ...
    private Vector2Int previousClickedPiecePosition;
    ...
    private void HandleMouseButtonUp(Vector2Int hitPosition)
    {
        ...
        if (hitPosition == previousClickedPiecePosition)
        {
            currentlyDragging
                .SetPosition(GetTileCenter(previousPiece.x, previousPiece.y));
            isPieceSelected = true;

            if (previousPiecePosition == previousClickedPiecePosition)
            {
                ToggleBool(ref isPieceDeselected);
            }
        ...
        previousClickedPiecePosition = hitPosition;
        previousPiecePosition = previousPiece;
        currentlyDragging
            .SetPosition(GetTileCenter(previousPiece.x, previousPiece.y));

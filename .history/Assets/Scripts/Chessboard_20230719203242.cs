...
#region  Initialization
    ...
    private void ActivatePromotion(Team team)
    {
        ...
        int x;
        SetPromotionPiecesObjectPosition (x, lastMove);
    ...
    private int SetPromotionPiecesObjectPosition(int positionX, var lastMove)
    {
        switch (lastMove.x)
        {
            case 0:
            ...
            case 1:
                return positionX = -120;
            case 2:
                return positionX = -30;
            case 3:
                return positionX = 50;
            case 4:
                return positionX = 140;
            case 5:
                return positionX = 220;
            case 6:
                return positionX = 310;
            case 7:
                return positionX = 400;
            default:
                return positionX = 0;
        }
    }

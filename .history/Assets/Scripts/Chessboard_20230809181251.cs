...
#region  Initialization
    ...
    public bool isPieceDeselected = false;
    ...
    //         if (previousPiecePosition == previousPiece)
    //         {
    //             ToggleBool(ref isPieceDeselected);
    //         }
    //         else if (previousPiecePosition != previousPiece)
    //         {
    //             isPieceDeselected = false;
    //         }
    //         previousPiecePosition = previousPiece;
    //         return;
    //     }
    //     currentlyDragging
    //         .SetPosition(GetTileCenter(previousPiece.x, previousPiece.y));
    ...
    private void HandleMouseButtonUp(Vector2Int hitPosition)
    {
        if (selectedPiece != null && selectedPiece == currentlyDragging)
        {
            if (
            ...
            )
            {
                ...
                selectedPiece = null;
                clickCount = 0; // Reset click count when the piece is moved
                return;
            }
            ...
            if (hitPosition == previousPiece)
            {
                ...
                clickCount++; // Increment click count for the next interaction with the piece
                return;
            }
        ...
        {
            // Handle any other mouse button up logic you have
        }
    }
    ...
    private void HandleMouseButtonDown(Vector2Int hitPosition)
    {
        ...
        if (selectedPiece == currentlyDragging)
        {
            clickCount++;
            if (
                clickCount % 3 == 1 // First click activates highlighting
            )
            {
                ...
                clickCount % 3 == 2 // Second click disables highlighting
            )
            {
                ...
                ClearAvailableMoves();
                return;
            } // Third click (and multiples) activates highlighting again
            else
            {
    ...
    private void ToggleBool(ref bool exampleBool)
    {

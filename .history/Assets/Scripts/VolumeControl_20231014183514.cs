...
public class VolumeControl : MonoBehaviour
{
    ...
    public void SetVolume(float sliderValue)
    {
        ...
        if (sliderValue == 0)
        {
            volumeIconImage.sprite = mutedVolumeImage;
        }
        else if (sliderValue > 0 && sliderValue < 0.3333f)
        {
            volumeIconImage.sprite = minVolumeImage;
        }
        else if (sliderValue >= 0.3333f && sliderValue < 0.6666f)
        {
            volumeIconImage.sprite = midVolumeImage;
        }
        else if (sliderValue >= 0.6666f)
        {
            volumeIconImage.sprite = maxVolumeImage;
        }
    }

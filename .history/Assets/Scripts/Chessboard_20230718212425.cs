...
#region  Initialization
    ...
    // Special moves
    private void ProcessSpecialMove(ChessPieceType promotionPieceType = ChessPieceType.None)
    {
        ...
        if (specialMove == SpecialMove.Promotion)
        {
            ...
            ActivatePromotion(promotionPieceType);
            }
            else {
    ...
    )
    {
        ...
        isPromoted = false;
        isReachable = true;
        promotionPieceType = ChessPieceType.None;
    }
    ...
    private void ProcessPromoting(ChessPieceType promotionPieceType)
    {
        ...
        Vector2Int currentPiecePosition = CloneChessPiece(currentPiece);

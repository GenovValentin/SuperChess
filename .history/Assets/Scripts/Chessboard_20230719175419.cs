...
#region  Initialization
    ...
    public string whiteQueenImagePath;

    public string blackQueenImagePath;

    public string whiteRookImagePath;

    public string blackRookImagePath;

    public string whiteBishopImagePath;

    public string blackBishopImagePath;

    public string whiteKnightImagePath;

    public string blackKnightImagePath;

...
public class Chessboard : MonoBehaviour
{
    ...
    // Positioning
    private void PoisitionAllPieces() {
    ...
    private bool MoveTo(ChessPiece cp, int x, int y) {
        ...
        if (chessPieces[x, y] != null) {
            ...
            if(ocp.team == 0) {
                ...
                ocp.SetPosition(new Vector3(7.5f * tileSize + 0.25f, yOffset, 8.4f * tileSize) 
                - bounds + new Vector3(tileSize / 2, 0, tileSize / 2) 
                + (Vector3.left * deathSpacing) * deadWhites.Count);
            }
            else {
                deadBlacks.Add(ocp);
                ocp.SetScale(Vector3.one * deathSize);
                ocp.SetPosition(new Vector3(-1 * tileSize + 0.25f, yOffset, -1.4f * tileSize) 
                - bounds + new Vector3(tileSize / 2, 0, tileSize / 2) 

...
public class Chessboard : MonoBehaviour {
    ...
    [SerializeField] private float yOffset = 0.11f;
            ...
            if (myPawn.currentX == enemyPawn.currentX) {
                if (myPawn.currentY == enemyPawn.currentY - 1 || myPawn.currentY == enemyPawn.currentY + 1) {
                    if (enemyPawn.team == 0) {
                        ...
                        enemyPawn.SetPosition(new Vector3(-1.4f * tileSize, yOffset, 7.75f * tileSize) 
                        ...
                        enemyPawn.SetScale(Vector3.one * deathSize);
                        enemyPawn.SetPosition(new Vector3(8.4f * tileSize, yOffset, -0.75f * tileSize) 
                        - bounds + new Vector3(tileSize / 2, 0, tileSize / 2) 
    ...
    private bool MoveTo(ChessPiece cp, int x, int y) {
        ...
        if (chessPieces[x, y] != null) {
            ...
            if(ocp.team == 0) {
                ...
                ocp.SetPosition(new Vector3(-1.4f * tileSize, yOffset, 7.75f * tileSize) 
                - bounds + new Vector3(tileSize / 2, 0, tileSize / 2) 
                + (Vector3.back * deathSpacing) * deadWhites.Count);
            }
            else {
                ...
                deadBlacks.Add(ocp);
                ocp.SetScale(Vector3.one * deathSize);
                ocp.SetPosition(new Vector3(8.4f * tileSize, yOffset, -0.75f * tileSize) 
                - bounds + new Vector3(tileSize / 2, 0, tileSize / 2) 
                + (Vector3.forward * deathSpacing) * deadBlacks.Count);
            }
        }

...
#region  Initialization
    ...
    private void SendDeclineToServer(byte wantDecline = 1)
    {
...
#region
    ...
    private void OnDeclineClient(NetMessage msg)
    {
        ...
        Invoke("ReDeclined", 3.0f);
    }

    private void Declined()
    {
        oppDeclinedObj.transform.gameObject.SetActive(true);
    }

    private void ReDeclined()
    {
        oppDeclinedObj.transform.gameObject.SetActive(false);
    }

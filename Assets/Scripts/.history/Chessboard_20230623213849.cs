...
#region  Initialization
    ...
    [SerializeField]
    private Transform drawIndicator;
    ...
    private void SetDrawObject()
    {
        ...
        oppDeclinedObj = drawIndicator.transform.GetChild(1).gameObject;
    }
    ...
    public void OnAcceptButton(NetMessage msg)
    {
        NetDraw dw = msg as NetDraw();
        playerDraw[0] = playerDraw[1] == 1;
...
#region
    ...
    private void ResetDrawIndicator()
    {
        ...
        oppDeclinedObj.SetActive(false);
        drawIndicator.transform.GetChild(2).gameObject.SetActive(false);
        drawIndicator.transform.GetChild(3).gameObject.SetActive(false);
    }
    ...
    private void ActivateDrawIndicatorChildren(bool oppWantsDraw)
    {
        if (localGame)
        {
            return;
        ...
        Debug.Log("objToActivate");
        GameObject objToActivate =
            oppWantsDraw ? oppOfferedObj : oppDeclinedObj;
        objToActivate.SetActive(true);
        drawIndicator.transform.GetChild(2).gameObject.SetActive(true);
        drawIndicator.transform.GetChild(3).gameObject.SetActive(true);
    }
    ...
    private void OnResignClient(NetMessage msg)
    {
        ...
        // bool oppHasResigned = rs.hasResigned == 1;
        // if (rs.teamID != (int) currentTeam)
        // {
        //     DisplayVictory (currentTeam);
        // }
        // DisplayVictory (currentTeam);
    ...
    private void OnDrawClient(NetMessage msg)
    {
        ...
        if (dw.teamNumber != (int) currentTeam)
        {
            ...
            ActivateDrawIndicatorChildren (oppWantsDraw);
        }

...
#region  Initialization
    ...
    public bool setInGameButtonsActive = false;
    ...
    private void Update()
    {
        ...
        if (setInGameButtonsActive == true)
        {
    ...
    private bool AreInGameButtonsActive(bool areButtonsActive)
    {
        return setInGameButtonsActive = areButtonsActive;
    }
